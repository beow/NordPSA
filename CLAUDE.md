...
- Not modelled: synchronous condensers, grid-forming batteries, AC-neighbour contributions to short-circuit power, and the expansion counterpart (capacity-based requirement with investable condensers and batteries) — planned, not built.
