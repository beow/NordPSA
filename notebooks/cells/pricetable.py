...
Tabellerar LABEL-körningens zonpriser (RÅA, ingen hydrogolv-kompensation — se
[[project_wv_comp_validity]]) mot en referens:
...
if LABEL2:
    ...
    ref_name, ref_src = LABEL2, 'körning, rå'
else:
    ref = mkt_prices.copy()
...
if _n is not None:
    ...
    print("\nLandaggregat (energivikt = LMA26-trogen):")
