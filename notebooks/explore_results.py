...
# ---------------------------------------------------------------------------
LABEL = "run240_baseline_dispatch_1h_3y"    # <-- byt körning här
LABEL2 = "run240_baseline_2h"                 # <-- jämförelsekörning för cell 9 (None = hoppa över)
# ---------------------------------------------------------------------------
...
# marginalkostnaden vattenvärdet, dvs dualen på lagringsbalansen.
