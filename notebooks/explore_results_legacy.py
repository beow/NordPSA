"""
⛔ LEGACY (2026-08-21): sparad inline-version, ersatt av explore_results.py som
nu importerar sin logik från notebooks/cells/*.py (bootstrap, ebalance, hydrocomp,
pricetable, prisgrafer, priceformation, soclevels, hydrodispatch, flexassets,
trading, prodstack, compareprice, marginal). Behåll den här filen orörd — den är
källan om någon av de nya cells/-modulerna (särskilt priceformation.py,
flexassets.py, trading.py, som saknade motsvarighet innan de skapades) behöver
jämföras mot originalet, eller om vi vill "göra riktiga celler" av fler bitar
härifrån senare. Kör INTE denna som den nya arbetsfilen.
"""
...
# ---------------------------------------------------------------------------
LABEL = "run400_expansion"    # <-- byt körning här
LABEL2 = "run360_baseline_2h"                 # <-- jämförelsekörning för cell 9 (None = hoppa över)
# ---------------------------------------------------------------------------
